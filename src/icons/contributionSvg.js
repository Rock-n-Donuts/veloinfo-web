    ...
    return withoutMarker
        ? `
            <svg width="50" height="58" viewBox="0 0 50 58" fill="none"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M34.2295 48.2411C43.4685 44.569 50 35.5473 50 25C50 11.1929 38.8071 0 25 0C11.1929 0 0 11.1929 0 25C0 35.5473 6.53156 44.569 15.7706 48.2411L25 57.4706L34.2295 48.2411Z" fill="${color}"/>
