...
function ContributionForm({ active, className, contributionType, onBack, onSuccess }) {
    ...
    const setPhotoValue = useCallback((e) => setPhoto(e.target.files[0]), [setPhoto]);
    ...
    const submit = useCallback(
        (e) => {
            ...
            if (coords === null) {
                setErrors(intl.formatMessage({ id: 'errors-coords' }));
                return;
            }
    ...
    return (
        ...
        >
            <div className={styles.content}>
                ...
                <FormGroup className={styles.comment} label={intl.formatMessage({ id: 'comment' })}>
                    <textarea value={comment} onChange={setCommentValue} />
                </FormGroup>
                <FormGroup className={styles.photo} label={intl.formatMessage({ id: 'photo' })}>
                    <input type="file" accept="image/*" onChange={setPhotoValue} />
                </FormGroup>
            ...
            <div className={styles.actions}>
                ...
                <button className={styles.submitButton} type="submit" disabled={coords === null}>
